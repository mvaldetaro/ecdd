...
var destFile                = 'ECDD.pot'; // Name of the transalation file.
var packageName             = 'ECDD'; // Package name.
var bugReport               = 'https://infnet.edu.br'; // Where can users report bugs.
var lastTranslator          = ''; // Last translator Email ID.
var team                    = 'ECDDTeam <ecdd@infnet.edu.br>'; // Team's Email ID.
...
// Style related.
var cssVendorSRC                = './assets/css/vendor.scss'; // Path to main .scss file.
var cssVendorDestination        = './'; // Path to place the compiled CSS file.
// Default set to root folder.
...
// Watch files paths.
var vendorStyleWatchFiles   = './assets/css/**/*.{scss, css}'; // Path to all *.scss files inside css folder and inside them.
 ...
 */
 gulp.task('vendor-styles', function () {
    ...
    .pipe( sourcemaps.write ( cssVendorDestination ) )
    .pipe( lineec() ) // Consistent Line Endings for non UNIX systems.
  ...
  */
 gulp.task( 'default', ['vendor-styles', 'styles', 'vendorsJs', 'customJS', 'images', 'browser-sync'], function () {
  gulp.watch( projectPHPWatchFiles, reload ); // Reload on PHP file changes.
  gulp.watch( vendorStyleWatchFiles, [ 'vendor-styles' ] ); // Reload on SCSS file changes.
