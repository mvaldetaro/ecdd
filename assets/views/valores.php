        ...
        <div class="col-md-4">
          <div class="valores__content__item">
            ...
            <div class="group">
              ...
              <p class="preco">R$ <?php the_sub_field('valor_com_desconto'); ?> mensais <span class="preco__integral">Valor Integral: R$<?php the_sub_field('valor_integral'); ?> mensais</span></p>
            </div>
            <?php
              endwhile;
              else :
          ...
          <div class="valores__content__item">
            ...
            <div class="group">
              ...
              <div class="text-center">
                <a href="#" class="btn btn-secondary btn-lg btn-lg-wide">Saiba Mais</a>
              </div>
            </div>
          </div>
        </div>
